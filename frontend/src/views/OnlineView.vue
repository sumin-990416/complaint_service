  ...
  <div class="flex flex-col bg-background">
    <section class="relative overflow-hidden bg-[#0f172a] text-white flex-shrink-0">
      ...
      <div class="relative page-gutter pt-3 pb-8">
        <p class="text-[11px] uppercase tracking-[0.24em] text-blue-300 font-semibold drop-shadow-sm">Online Application</p>
        <h1 class="hero-copy mt-2 font-bold tracking-tight drop-shadow-md">민원을 집에서 처리하세요</h1>
        <p class="mt-3 text-sm leading-7 text-white/95 drop-shadow-sm">
