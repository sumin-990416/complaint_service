      ...
      <div class="flex items-center gap-3 px-4 py-3 pl-5">
        ...
        <div class="flex-1 min-w-0">
          ...
          <div class="flex gap-1.5 mt-1.5 flex-wrap">
            <span v-if="office.nght_oper_yn === 'Y'" class="inline-flex items-center gap-1 text-[10px] font-semibold bg-violet-50 text-violet-700 px-2 py-0.5 rounded-full">
              <svg xmlns="http://www.w3.org/2000/svg" class="w-3 h-3" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M20.354 15.354A9 9 0 018.646 3.646 9.003 9.003 0 0012 21a9.003 9.003 0 008.354-5.646z"/></svg>
              야간
            </span>
            <span v-if="office.wknd_oper_yn === 'Y'" class="inline-flex items-center gap-1 text-[10px] font-semibold bg-emerald-50 text-emerald-700 px-2 py-0.5 rounded-full">
